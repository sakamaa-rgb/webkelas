...
export const initialJadwalPiket: JadwalPiket[] = [
  // Senin
  { id: 1, hari: 'Senin', nama_siswa: 'Aisyah', urutan: 1, pj: 'Alivia & Ainun', tipe: 'mbg' },
  { id: 2, hari: 'Senin', nama_siswa: 'Intan', urutan: 2, pj: 'Alivia & Ainun', tipe: 'mbg' },
  { id: 3, hari: 'Senin', nama_siswa: 'Nadine', urutan: 3, pj: 'Alivia & Ainun', tipe: 'mbg' },
  { id: 4, hari: 'Senin', nama_siswa: 'Salsa', urutan: 4, pj: 'Alivia & Ainun', tipe: 'kebersihan' },
  { id: 5, hari: 'Senin', nama_siswa: 'Abyan', urutan: 5, pj: 'Alivia & Ainun', tipe: 'kebersihan' },
  { id: 6, hari: 'Senin', nama_siswa: 'Dema', urutan: 6, pj: 'Alivia & Ainun', tipe: 'kebersihan' },
  { id: 7, hari: 'Senin', nama_siswa: 'Anzas', urutan: 7, pj: 'Alivia & Ainun', tipe: 'kebersihan' },
  { id: 8, hari: 'Senin', nama_siswa: 'Rajib', urutan: 8, pj: 'Alivia & Ainun', tipe: 'kebersihan' },
  { id: 9, hari: 'Senin', nama_siswa: 'Restu', urutan: 9, pj: 'Alivia & Ainun', tipe: 'kebersihan' },
  // Selasa
  { id: 10, hari: 'Selasa', nama_siswa: 'Alivia', urutan: 1, pj: 'Lulu & Oktavia', tipe: 'mbg' },
  { id: 11, hari: 'Selasa', nama_siswa: 'Khaira', urutan: 2, pj: 'Lulu & Oktavia', tipe: 'mbg' },
  { id: 12, hari: 'Selasa', nama_siswa: 'Nursyifa', urutan: 3, pj: 'Lulu & Oktavia', tipe: 'mbg' },
  { id: 13, hari: 'Selasa', nama_siswa: 'Ainun', urutan: 4, pj: 'Lulu & Oktavia', tipe: 'kebersihan' },
  { id: 14, hari: 'Selasa', nama_siswa: 'Bagus', urutan: 5, pj: 'Lulu & Oktavia', tipe: 'kebersihan' },
  { id: 15, hari: 'Selasa', nama_siswa: 'Faris', urutan: 6, pj: 'Lulu & Oktavia', tipe: 'kebersihan' },
  { id: 16, hari: 'Selasa', nama_siswa: 'Alif', urutan: 7, pj: 'Lulu & Oktavia', tipe: 'kebersihan' },
  { id: 17, hari: 'Selasa', nama_siswa: 'Refan', urutan: 8, pj: 'Lulu & Oktavia', tipe: 'kebersihan' },
  { id: 18, hari: 'Selasa', nama_siswa: 'Revand', urutan: 9, pj: 'Lulu & Oktavia', tipe: 'kebersihan' },
  // Rabu
  { id: 19, hari: 'Rabu', nama_siswa: 'Andini', urutan: 1, pj: 'Asyifa & Ranty', tipe: 'mbg' },
  { id: 20, hari: 'Rabu', nama_siswa: 'Lulu', urutan: 2, pj: 'Asyifa & Ranty', tipe: 'mbg' },
  { id: 21, hari: 'Rabu', nama_siswa: 'Oktavia', urutan: 3, pj: 'Asyifa & Ranty', tipe: 'mbg' },
  { id: 22, hari: 'Rabu', nama_siswa: 'Salwa', urutan: 4, pj: 'Asyifa & Ranty', tipe: 'kebersihan' },
  { id: 23, hari: 'Rabu', nama_siswa: 'Bramantyo', urutan: 5, pj: 'Asyifa & Ranty', tipe: 'kebersihan' },
  { id: 24, hari: 'Rabu', nama_siswa: 'Habib', urutan: 6, pj: 'Asyifa & Ranty', tipe: 'kebersihan' },
  { id: 25, hari: 'Rabu', nama_siswa: 'Candra', urutan: 7, pj: 'Asyifa & Ranty', tipe: 'kebersihan' },
  { id: 26, hari: 'Rabu', nama_siswa: 'Raffi Udin', urutan: 8, pj: 'Asyifa & Ranty', tipe: 'kebersihan' },
  { id: 27, hari: 'Rabu', nama_siswa: 'Rizky', urutan: 9, pj: 'Asyifa & Ranty', tipe: 'kebersihan' },
  // Kamis
  { id: 28, hari: 'Kamis', nama_siswa: 'Asyifa', urutan: 1, pj: 'Fanezza & Reisya', tipe: 'mbg' },
  { id: 29, hari: 'Kamis', nama_siswa: 'Maisi', urutan: 2, pj: 'Fanezza & Reisya', tipe: 'mbg' },
  { id: 30, hari: 'Kamis', nama_siswa: 'Ranty', urutan: 3, pj: 'Fanezza & Reisya', tipe: 'mbg' },
  { id: 31, hari: 'Kamis', nama_siswa: 'Nurul', urutan: 4, pj: 'Fanezza & Reisya', tipe: 'kebersihan' },
  { id: 32, hari: 'Kamis', nama_siswa: 'Crisna', urutan: 5, pj: 'Fanezza & Reisya', tipe: 'kebersihan' },
  { id: 33, hari: 'Kamis', nama_siswa: 'Ilham', urutan: 6, pj: 'Fanezza & Reisya', tipe: 'kebersihan' },
  { id: 34, hari: 'Kamis', nama_siswa: 'Hafiyz', urutan: 7, pj: 'Fanezza & Reisya', tipe: 'kebersihan' },
  { id: 35, hari: 'Kamis', nama_siswa: 'Nazhril', urutan: 8, pj: 'Fanezza & Reisya', tipe: 'kebersihan' },
  { id: 36, hari: 'Kamis', nama_siswa: 'Azzam', urutan: 9, pj: 'Fanezza & Reisya', tipe: 'kebersihan' },
  // Jumat
  { id: 37, hari: 'Jumat', nama_siswa: 'Faneza', urutan: 1, pj: 'Intan & Nadine', tipe: 'mbg' },
  { id: 38, hari: 'Jumat', nama_siswa: 'Mutia', urutan: 2, pj: 'Intan & Nadine', tipe: 'mbg' },
  { id: 39, hari: 'Jumat', nama_siswa: 'Reisya', urutan: 3, pj: 'Intan & Nadine', tipe: 'mbg' },
  { id: 40, hari: 'Jumat', nama_siswa: 'M. Aditya', urutan: 4, pj: 'Intan & Nadine', tipe: 'kebersihan' },
  { id: 41, hari: 'Jumat', nama_siswa: 'Davin', urutan: 5, pj: 'Intan & Nadine', tipe: 'kebersihan' },
  { id: 42, hari: 'Jumat', nama_siswa: 'Noval', urutan: 6, pj: 'Intan & Nadine', tipe: 'kebersihan' },
  { id: 43, hari: 'Jumat', nama_siswa: 'Rafli', urutan: 7, pj: 'Intan & Nadine', tipe: 'kebersihan' },
  { id: 44, hari: 'Jumat', nama_siswa: 'Taruna', urutan: 8, pj: 'Intan & Nadine', tipe: 'kebersihan' },
  { id: 45, hari: 'Jumat', nama_siswa: 'Niko', urutan: 9, pj: 'Intan & Nadine', tipe: 'kebersihan' }
];
